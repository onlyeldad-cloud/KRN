...
class AppCtrl extends ChangeNotifier {
  ...
  static sdk.Session _createSession({required sdk.Room room}) {
    // Only a personal development access token belongs on the client, never
    // LIVEKIT_API_SECRET or GOOGLE_API_KEY. Production needs user authentication.
    final endpoint = dotenv.env['KRN_TOKEN_ENDPOINT'] ?? 'http://10.0.2.2:3000/api/token';
    final accessToken = dotenv.env['KRN_MOBILE_DEV_TOKEN'] ?? '';
