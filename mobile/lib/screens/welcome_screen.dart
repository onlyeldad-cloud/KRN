              ...
              children: [
                ...
                Text.rich(
                  ...
                  TextSpan(
                    children: [
                      const TextSpan(
                        text: 'Willkommen bei KRN Agent. Sprich auf Deutsch, teile deine Kamera und finde Antworten. Hilfe zur Einrichtung: ',
                      ),
                      TextSpan(
                        text: 'Kurzanleitung',
                ...
                Consumer2<ctrl.AppCtrl, sdk.Session>(
                  builder: (ctx, appCtrl, session, child) {
                    ...
                    return buttons.Button(
                      text: isProgressing ? 'Verbinden …' : 'Mit KRN sprechen',
