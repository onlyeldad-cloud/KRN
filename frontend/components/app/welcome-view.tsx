  ...
  return (
    <div ref={ref}>
      <section className="flex flex-col items-center justify-center text-center">
        <WelcomeImage />
        <span className="mb-4 rounded-full border border-teal-400/30 px-4 py-2 text-xs tracking-widest uppercase">
          KRN Agent · Persönliche Assistenz
        </span>
        <h1 className="max-w-3xl text-5xl font-semibold tracking-tight md:text-7xl">
          Ein Gespräch.
          <br />
          <span className="text-teal-500">Viele Möglichkeiten.</span>
        </h1>
        ...
        <div className="mt-10 grid max-w-xl grid-cols-2 gap-3 text-sm md:grid-cols-4">
          {['Sprache & Chat', 'Kamera & Bildschirm', 'Suche & Wetter', 'Browser-Assistent'].map(
            (feature) => (
              <div
                key={feature}
                className="rounded-2xl border border-teal-400/20 bg-teal-400/5 px-4 py-3"
              >
                {feature}
              </div>
            )
